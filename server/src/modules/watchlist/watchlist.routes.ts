...
import { createWatchlistSchema, updateWatchlistSchema } from '@arahtamu/shared';
import type { CreateWatchlistInput, UpdateWatchlistInput, PaginationQuery } from '@arahtamu/shared';
