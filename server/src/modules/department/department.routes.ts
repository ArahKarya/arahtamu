...
import { createDepartmentSchema, updateDepartmentSchema } from '@fdm/shared';
import type { CreateDepartmentInput, UpdateDepartmentInput, PaginationQuery } from '@fdm/shared';
